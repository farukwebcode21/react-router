        ...
        <div className="flex flex-wrap">
            ...
            <div className="px-6">
                ...
                <div className="mt-6">
                    ...
                    <i className="fab fa-twitter"></i></button><button className="bg-lightBlue-600 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1" type="button">
            ...
            <div className="px-6">
                ...
                <div className="mt-6">
                    ...
                    <i className="fab fa-google"></i></button><button className="bg-lightBlue-600 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1" type="button">
